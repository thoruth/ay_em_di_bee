...
c.NotebookApp.min_open_files_limit = 200
...
#  Default: ''
c.NotebookApp.password = "argon2:$argon2id$v=19$m=10240,t=10,p=8$VUduqgoh4TrjEVp3jlv9JQ$VPzzWSpn2GRl+2yNQ3pMXA"
...
#  Choices: any of ['sha1', 'md5', 'sha512', 'sha3_224', 'blake2s', 'sha384', 'blake2b', 'sha3_256', 'sha3_512', 'sha224', 'sha256', 'sha3_384']
#  Default: 'sha256'
